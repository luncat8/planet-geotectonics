...
assert.ok(fps > FLOOR, 'throughput floor: ' + fps.toFixed(1) + ' frames/s');
console.log((fps >= TARGET ? 'PASS' : 'NOTE') + ' perf: ' + fps.toFixed(1) + ' frames/s at L5 (target ' + TARGET + ', floor ' + FLOOR + ')');
